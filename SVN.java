...
public class SVN extends AStructuredProfile {
	...
	protected Vector<IUnit> getPersistentConfig(String server, NetworkModel model) {
		...
		units.addAll(model.getServerModel(server).getBindFsModel().addBindPoint(server, model, "apache_webroot", "proceed", "/media/metaldata/www", "/media/data/www", "www-data", "www-data", "0755"));
		...
		units.addAll(model.getServerModel(server).getBindFsModel().addBindPoint(server, model, "svn_base_dir", "proceed", "/media/metaldata/svn", "/media/data/svn", "www-data", "www-data", "0755"));
