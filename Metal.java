...
public class Metal extends AStructuredProfile {
	...
	private String preseed(String server, String service, NetworkModel model, Boolean expirePasswords) {
	...
	private Vector<IUnit> buildIso(String server, String service, NetworkModel model, String preseed) {
	...
	private Vector<IUnit> buildVm(String server, String service, NetworkModel model, String bridge) {
