...
public class media extends AStructuredProfile {
	...
	protected Set<IUnit> getPersistentConfig() {
		...
		units.add(new FileAppendUnit("tc_fstab", "is_virtualbox_guest", "transcodeDir    /media/data/transcodeDir      vboxsf defaults,_netdev,uid=$(id candc -u),gid=$(id candc -g) 0 0", "/etc/fstab",
