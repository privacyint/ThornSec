...
public class NodeJS extends AStructuredProfile {
	...
	public Set<IUnit> getInstalled() {
		...
		units.add(new SimpleUnit("nodejs_setup_environment", "nodejs_is_executable_chmoded",
	...
	throws InvalidServerModelException {
		...
		networkModel.getServerModel(getLabel()).addEgress("deb.nodesource.com");
		networkModel.getServerModel(getLabel()).addEgress("npmjs.org");
		networkModel.getServerModel(getLabel()).addEgress("registry.npmjs.org");
