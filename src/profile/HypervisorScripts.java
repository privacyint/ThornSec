...
public class HypervisorScripts extends AStructuredProfile {
	...
	throws InvalidServerException {
		...
		units.add(new DirOwnUnit("recovery_scripts_dir", "recovery_scripts_dir_created", this.recoveryScriptsBase, "root"));
		units.add(new DirPermsUnit("recovery_scripts_dir", "recovery_scripts_dir_chowned", this.recoveryScriptsBase, "400"));
		...
		units.add(new DirOwnUnit("control_scripts_dir", "control_scripts_dir_created", this.controlScriptsBase, "root"));
		units.add(new DirPermsUnit("control_scripts_dir", "control_scripts_dir_chowned", this.controlScriptsBase, "400"));

		units.add(new DirUnit("watchdog_scripts_dir", "proceed", this.watchdogScriptsBase));
		units.add(new DirOwnUnit("watchdog_scripts_dir", "watchdog_scripts_dir_created", this.watchdogScriptsBase, "root"));
		units.add(new DirPermsUnit("watchdog_scripts_dir", "watchdog_scripts_dir_chowned", this.watchdogScriptsBase, "400"));
