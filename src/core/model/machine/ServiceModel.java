...
public class ServiceModel extends ServerModel {
	...
	public void init() throws AThornSecException {
		...
		if (getDisk("boot").isEmpty()) {
			...
			ADiskModel bootDisk = new ADiskModel("boot", Medium.DISK, Format.VMDK, bootDiskPath, DEFAULT_BOOT_DISK_SIZE, null, "autogenerated boot disk", getNetworkModel());
			addDisk(bootDisk);
		}
		if (getDisk("data").isEmpty()) {
			...
			ADiskModel dataDisk = new ADiskModel("data", Medium.DISK, Format.VMDK, dataDiskPath, DEFAULT_DATA_DISK_SIZE, null, "autogenerated data disk", getNetworkModel());
			addDisk(dataDisk);
		}
		if (getDisk("install").isEmpty()) {
			...
			ADiskModel dataDisk = new ADiskModel("debian", Medium.DVD, null, dataDiskPath, 666, null, "autogenerated iso disk", getNetworkModel());
			addDisk(dataDisk);
		}
	}
