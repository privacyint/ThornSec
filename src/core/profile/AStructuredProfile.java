...
/**
 * This represents a fully-fledged profile, designed to hold the
 * end-to-end configuration steps for something.
 * 
 * Profiles are intended to "outsource" tasks to specialised Units
 * or Profiles - Profiles, really, are aimed at holding _configuration_
 * rather than anything else. 
 * 
 * If you find yourself doing something more than once, think
 * about whether you should really be building a Unit for it.
 */
public abstract class AStructuredProfile extends AProfile {
	...
	throws AThornSecException {
		...
		children.addAll(this.getPersistentFirewall());
	...
	/**
	 * Expecting the configuration to change regularly? Put it in {@link #getLiveConfig()}!
	 * @throws AThornSecException 
	 */
	...
	/**
	 * This is Units for configurations you expect to change regularly,
	 * e.g. Devices or Servers or similar.
	 */
	 ...
	 */
	protected Set<IUnit> getPersistentFirewall()
	throws AThornSecException {
		return new HashSet<IUnit>();
	}
	 ...
	 * 
	 * If you want to do configuration of the firewall (e.g. add a Device)
	 * please see {@link #getPersistentFirewall()}
	 */
	protected Set<IUnit> getLiveFirewall()
	throws AThornSecException {
		return new HashSet<IUnit>();
	}

	/**
	 * This is where you put any initialisation Units you require.
	 * Please don't actually use this method, it will be going soon
	 */
	@Deprecated
