...
public class SingletonComplexUnit extends ComplexUnit {

	public SingletonComplexUnit(String name, String precondition, String config, String audit, String test,
			String result) {
